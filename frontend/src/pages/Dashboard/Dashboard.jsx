import {
  ...
  import BiddersAuctioneersGraph from "./subComponents/BiddersAuctioneersGraph";
  import PaymentGraph from "./subComponents/PaymentGraph";
  import PaymentProofs from "./subComponents/PaymentProofs";
        ...
        {loading ? (
          ...
          <>
            <div className="w-full ml-0 m-0 h-fit px-5 pt-20 lg:pl-[320px] flex flex-col gap-10">
              <h1
                className={`text-custom-hover text-2xl font-bold mb-2 min-[480px]:text-4xl md:text-6xl xl:text-7xl 2xl:text-8xl`}
              >
                Dashboard
              </h1>
